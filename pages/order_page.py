...
class OrderPage(BasePage):
    ...
    def select_metro_station(self, search_text, station_name):
        self.find(OrderPageLocators.METRO_INPUT).send_keys(search_text)
        locator = OrderPageLocators.metro_option(station_name)
        option = self.wait_until_visible(locator)
        option.click()
    ...
    def select_rent_period(self, period_text):
        ...
        self.click(OrderPageLocators.rent_period_option(period_text))
